 ...
 * @version 1
 */
public class Twitsh implements Sujeto {
    private ArrayList<Cliente> clientes;
    private String[] catalogo = {"AuronJouer", "ElBlondous", "Modelado con Rosa",
    "MizaZinfonia", "Hivai", "Mimja"};
     ...
     */
    public void setCobro(CobroTwitsh tipoCobro){
    ...
    public void agregar(Cliente cliente, int tipo){
        ...
        System.out.println("Bienvenido a Twitsh, " + cliente.getNombre() + " disfruta nuestro contenido!");
    }
     ...
     */
    public void cobrar(){
        System.out.println("\u001B[32m"+"Servicio de cobro, los programadores de Twitsh deben comer.");
        ...
        while(it.hasNext()){
            ...
            if (tipo == 1)
            setCobro(new CobroTwitshNormal());
            if (tipo == 2)
            setCobro(new CobroTwitshPremium());
        ...
        System.out.println("Twitsh se puso las pilas y les ha cobrado a todos sus usuarios");
        System.out.println(recomendaciones()+"\u001B[0m");
    }


    /**
     * Recomienda lo que el usuario puede ver del catalogo de Twitsh
     * @return las recomendaciones
     */
    public String recomendaciones(){
        Random r = new Random();
        String recomendaciones = "Ve tus mejores streamers en twitsh: ";
        for (int i =0; i<=2; i++){
